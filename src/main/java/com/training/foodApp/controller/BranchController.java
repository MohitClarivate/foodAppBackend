...
public class BranchController {
	...
	public ResponseEntity<ResponseStructure<Branch>> updateBranchById(@RequestBody Branch branch, @PathVariable int id) {
		return service.updateBranchById(branch , id);
	}
